...
class WhenTestingQueenMovement extends spock.lang.Specification
{
	...
	def "Test LegalMoves on Queen with Ennemy Rook"()
	{
		given:
		Rook blackRook = new Rook(blackRookPosition, board, Color.BLACK)
		Queen whiteQueen = new Queen(whiteQueenPosition, board, Color.WHITE)
		...
		where:
		blackRookPosition 	| whiteQueenPosition|  moveSize
